...
@section('sosa.content.User')
    ...
    <div class="container" id="ctn-smpart1">
        <h5 id="p-smpart1">SMA Art Wolfgang Amadeus Mozart </h5>
        <div class="row" id="row-smpart1-1">
            <div class="col-lg-3 col-md-3 col-sm-3"></div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                @foreach ($data as $smaart)
                <div class="card">
                    <img src="{{ Storage::url('public/img/') . $smaart->img_profilesekolah }}" alt="SMP ART" class="card-img-top" id="img-smpart">
                    <br>
                    <div class="card-body">
                        <p id="p-smpart2">{!! $smaart->profile_sekolah !!}</p>
                    </div>
                </div>
                @endforeach
            </div>
